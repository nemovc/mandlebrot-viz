...
>
	<div class="w-72 rounded-lg border border-neutral-700 bg-neutral-900 shadow-xl p-4 flex flex-col gap-3">
		<div class="text-sm font-medium text-white">Save Palette</div>

		{#if confirmOverwrite}
			<p class="text-xs text-neutral-300">
				A palette named <span class="text-white font-medium">"{nameInput.trim()}"</span> already exists. Overwrite?
			</p>
