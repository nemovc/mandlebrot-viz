...
class ViewerExportPool extends WorkerPool<ComputeJob, ComputeResult> {
  private static _instance: ViewerExportPool | null = null;
  static get instance(): ViewerExportPool {
    return (this._instance ??= new ViewerExportPool());
  }
